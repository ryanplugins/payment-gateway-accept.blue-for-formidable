	...
	margin-top: 3px;
		...
		">
			...
			<table class="form-table">
				...
				<?php echo '<tbody class="frm-ab-lite-pro-section"><tr class="frm-ab-lite-pro-badge-row"><td colspan="2"><div class="frm-ab-lite-inline-badge">Webhook &amp; Real-time Events</div></td></tr>'; ?>
				<tr>
					<th scope="row">
